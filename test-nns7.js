...
async function run() {
  ...
  const req = await fetch('https://neofura.ngd.network', {
    ...
    body: JSON.stringify({ jsonrpc: '2.0', id: 1, method: 'GetNep11PropertiesByContractHashTokenId', params: { ContractHash: '0x50ac1c37690cc2cfc594472833cf57505d5f46de', TokenIds: [tokenIdHex] } })
  });
