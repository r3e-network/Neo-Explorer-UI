...
async function deployContract() {
  try {
    ...
    // Hash is derived from sender scripthash, nef checksum and contract name.
    const manifestObj = JSON.parse(manifestStr);
    console.log("Contract Name:", manifestObj.name);
    console.log("To get the contract hash, inspect the transaction application log after it is accepted.");
  } catch (err) {
