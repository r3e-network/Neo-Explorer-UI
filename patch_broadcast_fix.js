...
// I'll extract just what's before the duplicated function
let parts = code.split('async function broadcastMessage');
let correctEnd = `async function broadcastMessage() {
...
fs.writeFileSync('src/views/Tools/BroadcastMessageTool.vue', parts[0] + correctEnd);
