          ...
          <table class="w-full">
            <thead class="bg-gray-50 dark:bg-gray-700">
              <tr>
                ...
                <th class="px-4 py-3 text-right text-sm font-medium text-gray-500">Votes</th>
                <th class="px-4 py-3 text-center text-sm font-medium text-gray-500">Status</th>
              </tr>
            </thead>
            <tbody class="divide-y dark:divide-gray-700">
              <tr v-for="(c, i) in candidates" :key="c.candidate" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                <td class="px-4 py-3 text-gray-500">{{ i + 1 }}</td>
                <td class="px-4 py-3">
                  <router-link :to="`/accountprofile/${c.candidate}`" class="text-primary-500 font-mono text-sm">
