    ...
    <section class="page-container py-6 md:py-8">
      ...
      <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-start gap-3">
          ...
          <div>
            <h1 class="page-title neon-glow-text">{{ $t('tools.gasEstimator.pageTitle') }}</h1>
      ...
      <div class="etherscan-card p-6 md:p-8">
        <div class="max-w-3xl mx-auto space-y-8">
          ...
          <div class="space-y-4">
            ...
            >
              <svg class="w-8 h-8 mx-auto mb-2 text-low" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  stroke-width="1.5"
            ...
            <transition-group name="list" tag="div" class="space-y-3">
              <div
                ...
                :key="i"
                class="flex gap-3 items-center bg-surface-muted p-2 pr-3 rounded-xl border border-line-soft relative group hover:border-primary-400 transition-colors"
              >
          ...
          <div class="pt-6 mt-6 flex justify-end border-t border-line-soft">
            ...
            >
              <svg v-if="isEstimating" class="w-5 h-5 animate-spin" fill="none" viewBox="0 0 24 24">
          ...
          <transition name="fade">
            <div v-if="result" class="mt-8 space-y-5">
              ...
              <div
                v-if="result.error"
                class="p-5 rounded-2xl border border-red-200 bg-red-50 text-red-700 dark:border-red-900/30 dark:bg-red-900/10 dark:text-red-400 font-medium text-sm break-all shadow-sm"
              >
                {{ result.error }}
              </div>
              ...
              <template v-else>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div
                    class="p-5 rounded-2xl border border-line-soft bg-surface text-center shadow-sm flex flex-col justify-center relative overflow-hidden group"
                  >
                    <div
                ...
                <div
                  class="p-6 rounded-2xl border border-orange-200 bg-gradient-to-br from-orange-50 to-orange-100/50 dark:border-orange-900/30 dark:from-orange-900/20 dark:to-orange-900/10 flex items-center justify-between shadow-inner"
                >
                  ...
                  <p class="text-3xl font-black text-orange-600 dark:text-orange-400 tracking-tight">
                    {{ result.totalFee }} <span class="text-sm font-bold opacity-80">GAS</span>
                  </p>
                </div>
