        ...
        <div class="max-w-3xl mx-auto space-y-6">
          ...
          <template v-else>
            ...
            <div v-if="operation === 'vote'" class="space-y-2 pt-2 animate-fade-in">
              <label class="block text-sm font-semibold text-high">Candidate Public Key</label>
              <input type="text" v-model="candidatePubKey" class="form-input w-full bg-surface text-high font-mono text-sm" placeholder="e.g. 03... (66 characters hex)" />
            </div>
