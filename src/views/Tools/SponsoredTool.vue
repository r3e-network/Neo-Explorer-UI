    ...
    <section class="page-container py-6 md:py-8">
      ...
      <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-start gap-3">
          ...
          <div>
            <h1 class="page-title neon-glow-text">{{ $t("tools.sponsored.title") }}</h1>
      ...
      <div class="etherscan-card p-6 md:p-8">
        <div class="max-w-3xl mx-auto space-y-6">
          <div
            class="p-4 rounded-xl bg-amber-50/80 backdrop-blur-sm border border-amber-200 dark:bg-amber-900/20 dark:border-amber-800/50 text-amber-800 dark:text-amber-300"
          >
          ...
          <div
            ...
            class="text-center py-10 border border-dashed border-line-soft rounded-xl bg-surface-muted"
          >
            <svg class="h-10 w-10 text-mid mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
                stroke-width="1.5"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div class="p-4 rounded-xl border border-line-soft bg-surface flex flex-col justify-center">
                ...
                <div class="flex items-center gap-2">
                  <span
                    v-if="isEligible"
                    class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400 text-xs font-bold uppercase tracking-wider"
                  >
                  ...
                  <span
                    v-else
                    class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400 text-xs font-bold uppercase tracking-wider"
                  >
                    <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                      <path
                        fill-rule="evenodd"
            ...
            <div class="space-y-4 pt-4 border-t border-line-soft">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <button
                  ...
                  :class="
                    operation === 'claim'
                      ? 'border-primary-500 bg-primary-50 dark:bg-primary-900/20 ring-1 ring-primary-500/50'
