              ...
              <div class="flex items-start gap-4">
                ...
                <div class="min-w-0">
                  ...
                  <p class="page-subtitle max-w-3xl">
                    The public command surface for Neo council decisions. Review official proposal packets, monitor
                    quorum pressure, and step into the signing workflow only when you need to act.
                  </p>
                </div>
              </div>
              ...
              <div class="mt-5 grid gap-4 md:grid-cols-3">
                ...
                >
                  ...
                  <p class="mt-1 text-sm text-mid">
                    Council witness fragments currently stored across the active queue.
                  </p>
                </div>
                <div
                  class="rounded-2xl border border-white/70 bg-white/80 p-4 shadow-sm backdrop-blur-sm dark:border-white/10 dark:bg-slate-950/70"
                >
                  ...
                  <p class="mt-1 text-sm text-mid">
                    Packets that already crossed quorum and can be submitted on-chain.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="grid gap-5 xl:grid-cols-[minmax(0,1fr)_240px]">
                <div class="min-w-0">
                  ...
                  <div class="mt-4 flex flex-wrap gap-3 text-xs">
                    ...
                    >
                    <button @click="viewDetails(req)" class="font-semibold text-primary-500 hover:underline">
                      View JSON / Details
                    </button>
                  </div>
                </div>
              ...
              <div v-if="createForm.mode === 'lab'" class="grid grid-cols-1 gap-4 md:grid-cols-[1fr,180px]">
                <div class="space-y-2">
                  ...
                  <p class="text-xs text-mid">
                    Include the connected wallet signer in this list. The tool will derive eligible signer addresses
                    from these public keys and use your chosen threshold instead of the live council threshold.
                  </p>
                </div>
                <div class="space-y-2">
                  <label class="block text-xs font-bold text-high uppercase tracking-wider opacity-80"
                  ...
                  />
                  <div
                    class="rounded-xl border border-dashed border-line-soft bg-surface/50 px-3 py-2 text-xs text-mid"
                  >
