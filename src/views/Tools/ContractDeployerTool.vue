    ...
    <section class="page-container py-6 md:py-8">
      ...
      <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-start gap-3">
          ...
          <div>
            <h1 class="page-title neon-glow-text">{{ $t("tools.contractDeployer.pageTitle") }}</h1>
      ...
      <div class="etherscan-card p-6 md:p-8">
        <div class="max-w-3xl mx-auto space-y-8">
          <div
            ...
            class="text-center py-12 border-2 border-dashed border-line-soft rounded-2xl bg-surface-muted/50"
          >
            <div
              class="h-16 w-16 bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center mx-auto mb-4"
            >
              <svg class="h-8 w-8 text-mid" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  stroke-width="1.5"
          ...
          <template v-else>
            ...
            <div class="space-y-3">
              ...
              >
                ...
                <template v-if="!nefFile">
                  <div
                    class="h-12 w-12 bg-surface-muted rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300 shadow-sm border border-line-soft"
                  >
                    <svg class="w-6 h-6 text-mid" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                        stroke-linecap="round"
                        stroke-linejoin="round"
                        stroke-width="1.5"
            ...
            <transition name="fade">
              <div
                v-if="txHash"
                class="p-5 rounded-2xl border border-emerald-200 bg-emerald-50 dark:border-emerald-900/30 dark:bg-emerald-900/10 text-emerald-800 dark:text-emerald-400 flex flex-col sm:flex-row items-start sm:items-center justify-between mt-6 gap-4 shadow-sm"
              >
                <div>
