    ...
    <section class="page-container py-6 md:py-8">
      ...
      <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-start gap-3">
          ...
          <div>
            <h1 class="page-title neon-glow-text">{{ $t('tools.candidateProfile.pageTitle') }}</h1>
        ...
        <div class="space-y-6">
          ...
          <div class="etherscan-card p-6 md:p-8">
            ...
            <div
              ...
              :class="{ 'bg-surface-elevated': !form.logoUrl }"
            >
              ...
              <template v-else>
                <div
                  class="w-16 h-16 rounded-full bg-primary-100 text-primary-500 dark:bg-primary-900/30 flex items-center justify-center mb-3"
                >
