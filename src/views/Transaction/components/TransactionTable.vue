    ...
    <table class="w-full min-w-[900px]" :aria-label="$t('aria.transactionsTable')">
      <thead class="table-head">
        <tr>
          ...
          <th scope="col" class="table-header-cell hidden md:table-cell">{{ $t("transactionsPage.colFrom") }}</th>
          <th scope="col" class="table-header-cell hidden lg:table-cell">{{ $t("transactionsPage.colTo") }}</th>
          <th scope="col" class="table-header-cell-right hidden lg:table-cell">{{ $t("transactionsPage.colValueGas") }}</th>
          <th scope="col" class="table-header-cell-right hidden xl:table-cell">{{ $t("transactionsPage.colNetSysFee") }}</th>
        </tr>
      </thead>
