<template>
  <div class="home-page min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <section class="hero-section relative overflow-hidden">
      <!-- Animated Background -->
      <div
        class="absolute inset-0 bg-gradient-to-br from-neo-green via-primary-700 to-primary-900"
      ></div>
      ...
      <div class="container mx-auto px-4 py-16 md:py-24 relative z-10">
        <div class="text-center mb-10">
          <!-- Logo -->
          <div
            class="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-white/10 backdrop-blur-sm mb-6"
          >
            <svg
            ...
            >
              <path
                d="M12 2L3 7v10l9 5 9-5V7l-9-5zm0 2.18l6.26 3.48L12 11.14 5.74 7.66 12 4.18zM5 8.82l6 3.33v6.52l-6-3.33V8.82zm8 9.85v-6.52l6-3.33v6.52l-6 3.33z"
              />
            </svg>
          </div>
          <h1
            class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 tracking-tight"
          >
            Neo N3 Explorer
          </h1>
          <p
            class="text-primary-100 text-lg md:text-xl max-w-2xl mx-auto opacity-90"
          >
            {{
        ...
        <div class="max-w-4xl mx-auto">
          <SearchBox
            ...
            :placeholder="
              ...
              'Search by Address / Txn Hash / Block / Token / Contract'
            "
          ...
          <div class="flex flex-wrap justify-center gap-3 mt-6">
            <router-link
              to="/blocks/1"
              class="quick-link px-4 py-2 rounded-full bg-white/10 hover:bg-white/20 text-white text-sm font-medium transition-all backdrop-blur-sm"
            >
              📦 Blocks
            </router-link>
            <router-link
    ...
    <section class="stats-banner py-6 -mt-8 relative z-20">
      <div class="container mx-auto px-4">
        <div
          class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-5 md:p-6"
        >
          <div
          ...
          >
            ...
            <div
              ...
              @click="
                $router.push(
                  '/NEP17tokeninfo/0xef4073a0f2b305a38ec4050e4d3d28bc40ea63f5'
                )
              "
            >
              <div class="flex items-center gap-2 mb-2">
                <div
                  class="w-8 h-8 rounded-full bg-gradient-to-br from-neo-green to-green-600 flex items-center justify-center shadow-sm"
                >
              ...
              <div class="flex items-baseline gap-2">
                <span
                  class="text-xl md:text-2xl font-bold text-gray-800 dark:text-white group-hover:text-primary-500 transition-colors"
                >
            ...
            <div
              ...
              @click="
                $router.push(
                  '/NEP17tokeninfo/0xd2a4cff31913016155e38e474a2c06d08be276cf'
                )
              "
            >
              <div class="flex items-center gap-2 mb-2">
                <div
                  class="w-8 h-8 rounded-full bg-gradient-to-br from-green-400 to-emerald-600 flex items-center justify-center shadow-sm"
                >
            ...
            <!-- Transactions -->
            <div
              class="stat-item hidden lg:block group cursor-pointer"
              @click="$router.push('/Transactions/1')"
            >
              <div class="flex items-center gap-2 mb-2">
                <div
    ...
    <section class="latest-section py-8">
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <!-- Latest Blocks -->
          <div
            class="card bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden"
          >
            <div
              class="card-header flex justify-between items-center p-5 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-primary-50 to-transparent dark:from-primary-900/20"
            >
              <div class="flex items-center gap-3">
                <div
                  class="w-11 h-11 rounded-xl bg-primary-500 flex items-center justify-center shadow-lg shadow-primary-500/30"
                >
                  <svg
              ...
              <router-link
                to="/blocks/1"
                class="flex items-center gap-1 px-4 py-2 rounded-lg bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 text-sm font-medium hover:bg-primary-100 dark:hover:bg-primary-900/50 transition-colors"
              >
          ...
          >
            <div
              class="card-header flex justify-between items-center p-5 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-green-50 to-transparent dark:from-green-900/20"
            >
              <div class="flex items-center gap-3">
                <div
                  class="w-11 h-11 rounded-xl bg-green-500 flex items-center justify-center shadow-lg shadow-green-500/30"
                >
                  <svg
                    class="w-6 h-6 text-white"
                    fill="currentColor"
              ...
              <router-link
                to="/Transactions/1"
                class="flex items-center gap-1 px-4 py-2 rounded-lg bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400 text-sm font-medium hover:bg-green-100 dark:hover:bg-green-900/50 transition-colors"
              >
                {{ $t("homePage.seeAll") || "View All" }}
                <svg
                  class="w-4 h-4"
    ...
    <section class="chart-section py-8 pb-12">
      <div class="container mx-auto px-4">
        <div
          class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-5 md:p-6"
        >
          <div
    ...
    async loadLatestData() {
      try {
        ...
        if (this.latestBlocks.length >= 2) {
          const timeDiff =
            this.latestBlocks[0].timestamp -
            this.latestBlocks[this.latestBlocks.length - 1].timestamp;
          const totalTxs = this.latestBlocks.reduce(
            (sum, b) => sum + (b.txcount || 0),
            0
          );
