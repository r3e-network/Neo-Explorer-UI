  ...
  >
    <div class="mx-4 w-full max-w-md rounded-lg bg-white p-6 shadow-xl dark:bg-gray-800">
      <div class="mb-4 flex items-center justify-between">
        <h3 class="text-sm font-semibold text-text-primary dark:text-gray-100">WalletConnect</h3>
      ...
      <p class="mb-3 text-xs text-text-secondary dark:text-gray-400">
      ...
      <p class="mt-4 flex items-center gap-2 text-xs text-text-secondary dark:text-gray-400">
