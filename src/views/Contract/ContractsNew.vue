      ...
      >
        <div class="p-4">
          ...
          <div v-else-if="error" class="text-center py-12">
            ...
            <p class="text-gray-700 dark:text-gray-300 font-semibold mb-1">Failed to load contracts</p>
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">{{ error }}</p>
            <button @click="loadContracts" class="px-4 py-2 bg-primary-500 hover:bg-primary-600 text-white rounded-lg text-sm font-medium transition-colors">
              Try Again
            </button>
          </div>
