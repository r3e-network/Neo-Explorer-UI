      ...
      <div class="page-container relative z-30 py-10 md:py-14">
        <div class="mx-auto max-w-4xl text-center">
          ...
          <div class="flex justify-center items-center gap-3">
            <span
              v-if="account"
              class="text-sm font-medium text-white px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20"
            >
            ...
            <div class="flex-1">
              <div class="flex items-center gap-3 mb-2">
                ...
                <span
                  ...
                  class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-400 text-sm font-bold"
                >
                ...
                <span
                  v-else
                  class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-400 text-sm font-bold"
                >
                  <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path
                      fill-rule="evenodd"
...
async function registerDomain() {
  ...
  try {
    ...
    const params = [domain, hexToBytes(scriptHash)];
...
async function transferDomain() {
  ...
  try {
    ...
    const params = [hexToBytes(toScriptHash), hexToBytes(tokenIdHex), null];
