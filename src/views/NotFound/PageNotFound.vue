<template>
  <div class="page-not-found min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
    <div class="text-center px-4">
      ...
      <p class="text-gray-500 mb-8">Sorry, the page you're looking for doesn't exist.</p>
      <router-link to="/" 
