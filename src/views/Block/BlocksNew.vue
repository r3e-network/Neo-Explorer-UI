    ...
    <div class="container mx-auto px-4 py-8">
      ...
      >
        ...
        <div v-else-if="error" class="p-8 text-center">
          ...
          <p class="text-gray-700 dark:text-gray-300 font-semibold mb-1">Failed to load blocks</p>
          <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">{{ error }}</p>
          <button @click="loadBlocks" class="px-4 py-2 bg-primary-500 hover:bg-primary-600 text-white rounded-lg text-sm font-medium transition-colors">
            Try Again
          </button>
        </div>
        ...
        <div v-else-if="blocks.length === 0" class="p-8 text-center">
          ...
          <p class="text-gray-500 dark:text-gray-400 font-medium">No blocks found</p>
        </div>
