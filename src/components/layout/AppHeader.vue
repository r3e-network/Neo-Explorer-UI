            ...
            >
              <div class="flex items-center gap-3">
                <div class="h-10 w-10 rounded-full bg-white dark:bg-slate-800 shadow-sm flex items-center justify-center border border-line-soft p-2">
                  ...
                  <img v-else-if="provider === 'WalletConnect'" :src="'/img/brand/walletconnect.png'" alt="WalletConnect" class="w-full h-full object-contain" onerror="this.src='/img/brand/neo.png'" />
                  <img v-else-if="provider === 'Neon Wallet'" :src="'/img/brand/neo.png'" alt="Neon Wallet" class="w-full h-full object-contain" />
                  <img v-else-if="provider === 'OneGate'" :src="'/img/brand/neo.png'" alt="OneGate" class="w-full h-full object-contain" />
