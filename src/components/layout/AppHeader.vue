<template>
  <header class="app-header sticky top-0 z-50">
    <!-- Top Bar - Price Info -->
    <div class="top-bar bg-gray-100 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
        ...
        <div class="flex items-center justify-between h-8 text-xs">
          <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-1.5">
              ...
              <span class="font-medium text-gray-700 dark:text-gray-200">${{ neoPrice }}</span>
            ...
            <div class="flex items-center gap-1.5">
              ...
              <span class="font-medium text-gray-700 dark:text-gray-200">${{ gasPrice }}</span>
            ...
            <div class="hidden md:flex items-center gap-1.5">
              ...
              <span class="font-medium text-gray-700 dark:text-gray-200">{{ networkFee }} GAS</span>
            </div>
          </div>
          <div class="flex items-center gap-3">
            ...
            <div class="relative" ref="networkDropdown">
              ...
              >
                ...
                <span class="text-gray-600 dark:text-gray-300">{{ currentNetwork }}</span>
              ...
              >
                ...
                >
                  <span class="w-2 h-2 rounded-full" :class="net.id === currentNetwork ? 'bg-green-500' : 'bg-gray-300'"></span>
                  {{ net.name }}
                </button>
              </div>
            </div>
    ...
    <!-- Main Navigation -->
    <nav class="main-nav bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
      <div class="container mx-auto px-4">
        <div class="flex items-center justify-between h-14">
          <!-- Logo -->
          <router-link to="/" class="flex items-center gap-2 flex-shrink-0">
            <div class="w-8 h-8 bg-gradient-to-br from-neo-green to-primary-500 rounded-lg flex items-center justify-center">
              <span class="text-white font-bold text-sm">N3</span>
            </div>
            <div class="hidden sm:block">
              <span class="font-bold text-gray-800 dark:text-white text-lg">NeoScan</span>
          ...
          <div class="hidden lg:flex items-center gap-1">
            ...
            <!-- Blockchain Dropdown -->
            <div class="relative" @mouseenter="openDropdown('blockchain')" @mouseleave="closeDropdown('blockchain')">
              ...
              <div v-show="activeDropdown === 'blockchain'" class="dropdown-menu">
                ...
                <router-link to="/Transactions/1" class="dropdown-item">
                  ...
                  <div>
                    ...
                    <div class="text-xs text-gray-400">View all transactions</div>
                  </div>
                </router-link>
            ...
            <!-- Tokens Dropdown -->
            <div class="relative" @mouseenter="openDropdown('tokens')" @mouseleave="closeDropdown('tokens')">
              <button class="nav-item flex items-center gap-1">
                Tokens
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
              ...
              <div v-show="activeDropdown === 'tokens'" class="dropdown-menu">
                ...
                <router-link to="/tokens/nep17/neo" class="dropdown-item">
                  <div class="w-4 h-4 rounded-full bg-neo-green/20 flex items-center justify-center">
            ...
            <!-- Contracts -->
            <router-link to="/contracts/1" class="nav-item">Contracts</router-link>

            <!-- Resources Dropdown -->
            <div class="relative" @mouseenter="openDropdown('resources')" @mouseleave="closeDropdown('resources')">
              <button class="nav-item flex items-center gap-1">
                Resources
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
              ...
              <div v-show="activeDropdown === 'resources'" class="dropdown-menu">
    ...
    >
      <div class="container mx-auto px-4 py-4">
        ...
        <!-- Mobile Nav Links -->
        <div class="space-y-1">
          <router-link to="/" class="mobile-nav-item" @click="mobileMenuOpen = false">Home</router-link>
          <router-link to="/blocks/1" class="mobile-nav-item" @click="mobileMenuOpen = false">Blocks</router-link>
          <router-link to="/Transactions/1" class="mobile-nav-item" @click="mobileMenuOpen = false">Transactions</router-link>
          <router-link to="/tokens/nep17/1" class="mobile-nav-item" @click="mobileMenuOpen = false">NEP-17 Tokens</router-link>
          <router-link to="/tokens/nep11/1" class="mobile-nav-item" @click="mobileMenuOpen = false">NFTs</router-link>
          <router-link to="/contracts/1" class="mobile-nav-item" @click="mobileMenuOpen = false">Contracts</router-link>
          <router-link to="/account/1" class="mobile-nav-item" @click="mobileMenuOpen = false">Accounts</router-link>
          <router-link to="/charts" class="mobile-nav-item" @click="mobileMenuOpen = false">Charts</router-link>
        </div>
      </div>
    </div>
  </header>
  ...
  methods: {
    ...
    async handleSearch() {
      ...
      try {
        ...
        if (result.type === 'block') {
          this.$router.push(`/blockinfo/${result.data.hash || this.searchQuery}`)
        } else if (result.type === 'transaction') {
          this.$router.push(`/transactionInfo/${result.data.hash || this.searchQuery}`)
        } else if (result.type === 'contract') {
          this.$router.push(`/contractinfo/${result.data.hash || this.searchQuery}`)
    ...
    async loadPrices() {
      try {
        ...
        this.neoPrice = (data.neo?.usd || 12.50).toFixed(2)
        this.gasPrice = (data.gas?.usd || 4.20).toFixed(2)
