  ...
  <div class="tx-list-item p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
    <div class="flex items-center justify-between gap-4">
      ...
      <div class="flex items-center gap-3 min-w-0">
        <div class="tx-icon w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0"
             :class="statusClass">
      ...
      <!-- Middle: From/To -->
      <div class="hidden md:flex flex-1 items-center justify-center gap-2 min-w-0">
