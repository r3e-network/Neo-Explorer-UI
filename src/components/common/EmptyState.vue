<template>
  <div class="text-center py-12 px-4">
    ...
    >
      ...
      >
        <path
          d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6zm-1 2l5 5h-5V4zM8 17h8v-2H8v2zm0-4h8v-2H8v2z"
        />
      </svg>
      <!-- Search icon -->
      <svg
...
defineProps({
  ...
  icon: {
    type: String,
    default: "default",
    validator: (v) => ["block", "tx", "token", "contract", "search", "default"].includes(v),
  },
