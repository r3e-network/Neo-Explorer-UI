...
const nefPath = path.resolve(repoRoot, "contracts/AbstractAccount/bin/sc/AbstractAccount.nef");
const manifestPath = path.resolve(repoRoot, "contracts/AbstractAccount/bin/sc/AbstractAccount.manifest.json");
