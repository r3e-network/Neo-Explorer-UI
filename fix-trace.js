...
let traceView = fs.readFileSync('src/views/Transaction/components/TxExecutionTraceTab.vue', 'utf8');

// The issue is that the TxExecutionTraceTab contains a "View Full Execution Trace" button
// that links to `/tx/.../trace` but also displays some redundant/barebones logic beneath it.
// And there is already a beautiful ExecutionTraceView component built in `src/components/trace/ExecutionTraceView.vue`.
...
fs.writeFileSync('src/views/Transaction/components/TxExecutionTraceTab.vue', replacement);
